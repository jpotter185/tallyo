...
`tallyo` is a Next.js (App Router) UI for viewing sports games with live updates, game details, standings, and league dashboards. Supported leagues: `nfl`, `cfb`, `nhl`, `mls`. Deployed on Vercel at https://tallyo.us.
